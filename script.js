...
const Mv1 = new Movie("Spider-Man", "Marvel", "ALL");
console.log(Mv1);

// b) The constructor for the class Movie will set the class property rating to "PG" as default when no rating is provided.

const Mv2 = new Movie("Spider-Man-2", "Marvel");
console.log(Mv2);

const Mv3 = new Movie("Spider-Man-3", "Marvel");
console.log(Mv3);
...
const Mv4 = new Movie("Casino Royale", "Eon Productions", "PG13");
console.log(Mv4);
...
let P1 = new Person("Pranit", "Yadav", "Doctor", "24");
console.log(P1);
